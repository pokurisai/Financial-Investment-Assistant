...
import { faCheckCircle, faInfo, faExclamationTriangle, faExclamationCircle } from '@fortawesome/free-solid-svg-icons';
...
const ToastContent = ({ type, message }) => {
    ...
    return (
        <div className={contentObj.classNames}>
            <span className='p-10'>
                <FontAwesomeIcon className="icon-size" icon={contentObj.iconInfo}  >
                </FontAwesomeIcon>
            </span>
